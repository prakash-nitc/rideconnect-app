...
const RideDetailModal = ({ ride, open, onClose }: RideDetailModalProps) => {
  if (!ride) return null;
  ...
  const handleJoinRide = () => {
    toast.success('Join request sent!', {
      description: `You've joined ${ride.postedBy}'s ride. A group chat will be created in the real app.`,
    });
    onClose();
  };
      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="space-y-5 pt-2">
          ...
          <p className="text-xs text-center text-muted-foreground">
            This is a demo. In the real app, you'll be added to a group chat with other riders.
          </p>
        </div>
      </DialogContent>
    </Dialog>
